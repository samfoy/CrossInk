...
const StrId menuNames[MENU_ITEMS] = {StrId::STR_USERNAME,          StrId::STR_PASSWORD,
                                     ...
                                     StrId::STR_UPLOAD_READING_STATS, StrId::STR_AUTHENTICATE};
}  // namespace
...
void KOReaderSettingsActivity::handleSelection() {
  if (selectedIndex == 0) {
    ...
    // Upload Reading Stats (BookOrbit) - toggle On/Off
  ...
  GUI.drawList(
      ...
      [this](int index) {
        ...
        if (index == 0) {
          ...
          return SETTINGS.uploadReadingStats ? std::string(tr(STR_ENABLED)) : std::string(tr(STR_DISABLED));
        } else if (index == 5) {
